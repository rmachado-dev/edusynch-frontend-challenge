...
const Header = () => {
  return (
    <>
      ...
      >
        <Container>
          <img alt='imagem' src={logo} className="img-fluid me-5" />
      ...
      >
        <Container className="d-flex justify-content-start align-center h-100">
          <Navbar.Toggle aria-controls="menu-collapse">
            <img alt='imagem' src={hamb} className="img-fluid align-center " />
          </Navbar.Toggle>
          <img alt='imagem' src={logo} className="img-fluid ms-2" />

          <Navbar.Collapse id="menu-collapse">
            <Nav className="me-auto">
              {/* logo e close */}
              <div className="d-flex justify-content-between align-items-center">
                <img alt='imagem' src={logo} className=" h-100" />
                <Navbar.Toggle aria-controls="menu-collapse">
